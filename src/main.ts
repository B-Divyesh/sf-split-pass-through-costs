import './style.css';
import { deleteSlip, exportBackup, getAttachment, getSlip, importBackup, listSlips, putAttachment, putSlip, resetDemoStorage, setStorageMode } from './db';
...
function notFound(): void {
  ...
  app.innerHTML = `<header class="site-header"><a class="wordmark" href="/"><span aria-hidden="true">S/</span> Split Cost Slip</a><nav aria-label="Site navigation"><a href="/demo">Demo</a><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a></nav></header><div id="route-announcer" class="visually-hidden" aria-live="polite"></div><main id="main" class="not-found"><p class="eyebrow">404 / missing sheet</p><h1 id="page-title" tabindex="-1">This slip is not here.</h1><p>The page may have moved. Return to the cost splitter or open the sample.</p><p class="route-actions"><a class="primary-action" href="/">Return home</a><a class="secondary-action" href="/demo">Open the demo</a></p></main><footer><p>Split Cost Slip separates one bill into billable costs and overhead.</p><nav aria-label="Legal"><a href="/demo">Demo</a><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a><a href="https://github.com/B-Divyesh/sf-split-pass-through-costs">Source on GitHub (external)</a></nav><p>Built by Param Factory · build polish-3</p></footer>`;
